...
- Exportacao de historico para CSV.
- Banco de questoes por disciplina/turma.
- Relatorios por aluno e por habilidade.
- Controle de permissao por professor.

## Licenca

Projeto educacional interno. Ajuste esta secao conforme a politica institucional desejada.
